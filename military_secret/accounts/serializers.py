...
class CarSerializer(serializers.ModelSerializer):
    ...
    class Meta:
        model = Car
        fields = ['id', 'car_model', 'car_type', 'year', 'country', 'color',
                  'mark', 'wheel_type', 'car_number', 'dossier']
...
class DossierSerializer(serializers.ModelSerializer):
    ...
    class Meta:
        model = Dossier
        fields = [ 'id','image','full_name','date_birth',
                   'address','department','phone','experience','cars']
